...
function LibraryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LibraryPage.useEffect": ()=>{
            const fetchLibrary = {
                "LibraryPage.useEffect.fetchLibrary": async ()=>{
                    ...
                    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('user_library').select('*').eq('user_id', user.id);
                    if (error) {
                        console.error('Fetch error:', error.message);
                    } else {
                        console.log('Fetched library items:', data);
                        setItems(data || []);
                        const detailed = await Promise.all(data.map({
                            "LibraryPage.useEffect.fetchLibrary": async (item)=>{
                                const media = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$anilist$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchMediaById"])(item.media_id);
                                return {
                                    ...item,
                                    media
                                };
                            }
                        }["LibraryPage.useEffect.fetchLibrary"]));
                        setItems(detailed);
                    }
                    setLoading(false);
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            'anime',
            'manga'
        ].map((mediaType)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                children: [
                    ...
                    statuses.map((status)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "mb-6",
                            children: [
                                ...
                                grouped?.[mediaType]?.[status]?.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    children: grouped?.[mediaType]?.[status]?.map((item)=>item?.media_id && item?.media_type ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                            ...
                                            children: item.media?.coverImage?.medium ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
...
_s(LibraryPage, "X0A+44AtCQpjgFsTFhgdow3TGVs=");
_c = LibraryPage;
var _c;
...
//# sourceMappingURL=_03824f25._.js.map