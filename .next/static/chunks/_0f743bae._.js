...
const handleDiscordLogin = async ()=>{
    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
        provider: 'discord',
        options: {
...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        e.preventDefault();
        const { error: loginError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            email,
            password
        });
        if (loginError) {
...
_s(LoginPage, "/gT+fs470sS97GAQG3xtJKY+RiQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = LoginPage;
function createSupabaseClient(remember) {
...
//# sourceMappingURL=_0f743bae._.js.map